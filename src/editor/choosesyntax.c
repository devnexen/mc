...
exec_edit_syntax_dialog (const GPtrArray * names, const char *current_syntax)
{
    ...
    LISTBOX_APPEND_TEXT (syntaxlist, 'A', _("< Auto >"), NULL, NULL);
    LISTBOX_APPEND_TEXT (syntaxlist, 'R', _("< Reload Current Syntax >"), NULL, NULL);
    ...
    for (i = 0; i < names->len; i++)
    {
        ...
        LISTBOX_APPEND_TEXT (syntaxlist, 0, name, NULL, NULL);
